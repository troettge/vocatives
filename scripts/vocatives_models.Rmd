...
With by-language random effects:
...
mod_prosody_strict_language <- brm(prosody_clean ~ case_broad_sum + (1 + case_broad_sum | family1) + (1 + case_broad_sum | macroarea) + (1 + case_broad_sum | language),
            data=v_acc_voc, family="bernoulli", cores=2, control=list(adapt_delta=0.99),
...
marginal_effects(mod_v_height_language, categorical=T)
```